...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $stmt = mysqli_prepare($conn, "SELECT codigo_barra, cantidad FROM lotes WHERE id = ?");
        ...
        $stmt2 = mysqli_prepare($conn, "SELECT precio_compra, precio_venta, cantidad FROM productos WHERE codigo_barra = ?");
        ...
        $total_compra_restar = $cantidad_lote * $precio_compra;
